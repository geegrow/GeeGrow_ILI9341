/*!
 * @file GeeGrow_ILI9341_objectFillRect.h
 *
...
#ifndef GEEGROW_ILI9341_OBJECT_FILL_RECT_H
#define GEEGROW_ILI9341_OBJECT_FILL_RECT_H

#include "GeeGrow_ILI9341_objectBase.h"

/**************************************************************************/
/*!
    @brief    Parent class that stores state and functions of object filled rectangle
*/
/**************************************************************************/
class GeeGrow_ILI9341_objectFillRect : public GeeGrow_ILI9341_objectBase {
    public:
        GeeGrow_ILI9341_objectFillRect(
            uint8_t _objectType,
...
#endif /* GEEGROW_ILI9341_OBJECT_FILL_RECT_H */
